...
async def test_list_reviews_requires_business_id(api_client: AsyncClient):
    resp = await api_client.get("/api/v1/reviews/organization/00000000-0000-0000-0000-000000000000")
...
async def test_create_review_requires_auth(api_client: AsyncClient):
    resp = await api_client.post(
        "/api/v1/reviews/organization/00000000-0000-0000-0000-000000000000",
        json={
            "rating": 5,
            "comment": "Great place!",
        },
