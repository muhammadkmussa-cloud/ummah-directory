...
class Organization(BaseModelMixin):
    ...
    managers: Mapped[list[OrganizationManager]] = relationship(
        "OrganizationManager", back_populates="organization", cascade="all, delete-orphan"
    )
    ...
    media: Mapped[list[MediaFile]] = relationship(
        "MediaFile", back_populates="organization", cascade="all, delete-orphan"
    )
    events: Mapped[list[Event]] = relationship(
        "Event", back_populates="organization", cascade="all, delete-orphan"
    )
    favorites: Mapped[list[Favorite]] = relationship(
        "Favorite", back_populates="organization", cascade="all, delete-orphan"
    )
    followers: Mapped[list[OrganizationFollow]] = relationship(
        "OrganizationFollow", back_populates="organization", cascade="all, delete-orphan"
    )
    claims: Mapped[list[OwnershipClaim]] = relationship(
        "OwnershipClaim", back_populates="organization", cascade="all, delete-orphan"
    )
