"""clean_migration_after_manual_schema

Revision ID: 21a8bf1a7ba5
Revises: 184ead356f54
Create Date: 2026-07-24 20:58:54.440420
"""
...
revision: str = '21a8bf1a7ba5'
down_revision: Union[str, None] = '184ead356f54'
...
def upgrade() -> None:
    ...
    op.drop_index(op.f('ix_conv_org_id'), table_name='conversations')
    op.drop_index(op.f('ix_fav_coll_user_id'), table_name='favorite_collections')
    op.drop_index(op.f('ix_fav_coll_id'), table_name='favorites')
    op.drop_index(op.f('ix_msg_conv_id'), table_name='messages')
    op.drop_index(op.f('ix_spm_user_id'), table_name='saved_payment_methods')
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index(op.f('ix_spm_user_id'), 'saved_payment_methods', ['user_id'], unique=False)
    op.create_index(op.f('ix_msg_conv_id'), 'messages', ['conversation_id'], unique=False)
    op.create_index(op.f('ix_fav_coll_id'), 'favorites', ['collection_id'], unique=False)
    op.create_index(op.f('ix_fav_coll_user_id'), 'favorite_collections', ['user_id'], unique=False)
    op.create_index(op.f('ix_conv_org_id'), 'conversations', ['organization_id'], unique=False)
