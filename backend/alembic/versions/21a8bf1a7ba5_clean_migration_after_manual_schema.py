...
def upgrade() -> None:
    ...
    op.execute('DROP INDEX IF EXISTS ix_conv_org_id')
    op.execute('DROP INDEX IF EXISTS ix_fav_coll_user_id')
    op.execute('DROP INDEX IF EXISTS ix_fav_coll_id')
    op.execute('DROP INDEX IF EXISTS ix_msg_conv_id')
    op.execute('DROP INDEX IF EXISTS ix_spm_user_id')
